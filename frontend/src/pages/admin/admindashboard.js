...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const complaintsResponse = await axios.get('https://deploy-mernapi.vercel.app/complaints/count');
        const resolvedResponse = await axios.get('https://deploy-mernapi.vercel.app/complaints/resolved/count');
        const progressResponse = await axios.get('https://deploy-mernapi.vercel.app/complaints/progress/count');
        const binsResponse = await axios.get('https://deploy-mernapi.vercel.app/bins/count');
        const usersResponse = await axios.get('https://deploy-mernapi.vercel.app/users/count');
        const driversResponse = await axios.get('https://deploy-mernapi.vercel.app/drivers/count');
